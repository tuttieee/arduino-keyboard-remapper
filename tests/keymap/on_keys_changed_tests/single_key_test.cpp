...
TEST_F(SingleKeyTest, NoKeyPressed) {
  ...
  onKeysChanged(keymaps, keymapSize, keyPressedFlags, mod, sortedKeysBefore, sortedKeysAfter, &isMappedModChanged, &mappedMod, pressedKeys, releasedKeys);
